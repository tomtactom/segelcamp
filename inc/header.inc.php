...
<html lang="de" moznomarginboxes mozdisallowselectionprint>
	<head>
	  ...
	  <meta name="description" content="Melden Sie Ihr Kind jetzt für das Segelcamp 2022 an und erfahren Sie weitere Informationen über dieses. Wir freuen uns auf Euch.">
	...
	<body class="is-preload">
		<div id="wrapper">
			<div id="main">
	            ...
	            <li class="not_print"><a href="mailto:segelcamp@lohheider-see.de" class="icon far fa-envelope"><span class="label">E-Mail</span></a></li>
						</ul>
					</header>
