...
function send_acception_mail($sender_name, $sender_mail) {
 ...
 if($publishphotos == 1) {
  ...
  $text_bestaetigung = "Hallo ".$sender_name.", <br>
  ...
  <p>Sie oder das andere Elternteil hat bestätigt, dass alle Angaben richtig sind, dem Kind erklärt, dass am, auf und im Wasser Schwimmwestenpflicht besteht. Sollten Sie festgestellt haben, dass die Angaben doch nicht richtig sind, teilen Sie uns dies bitte mit, dann können wir diese für Sie anpassen. Dazu können Sie ganz einfach auf diese E-Mail antworten.</p><br>
